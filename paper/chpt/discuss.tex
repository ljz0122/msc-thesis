...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\linewidth]{paper//figs//discuss/snaqs_missed_quasars.png}
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \includegraphics[width=\linewidth]{paper/figs/discuss/sdss_qso_pm_significance.png}
        \caption{SDSS DR16Q}
        \label{fig:pm_sdss}
    \end{subfigure}
    \begin{subfigure}[b]{0.48\textwidth}
        \includegraphics[width=\linewidth]{paper/figs/discuss/lamost_qso_pm_significance.png}
        \caption{LAMOST Quasar Survey (DR2-11)}
        \label{fig:pm_lamost}
    \end{subfigure} \\
    \begin{subfigure}[b]{0.48\textwidth}
        \includegraphics[width=\linewidth]{paper/figs/discuss/milliquas_qso_pm_significance.png}
        \caption{Milliquas v8}
        \label{fig:pm_milliquas}
    \end{subfigure} 
    \begin{subfigure}[b]{0.48\textwidth}
        \includegraphics[width=\linewidth]{paper/figs/discuss/lqac6_qso_pm_significance.png}
        \caption{LQAC-6}
        \label{fig:pm_lqac6}
    \end{subfigure} 
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\linewidth]{paper//figs//discuss/rayleigh_halfnorm_cdf.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\linewidth]{paper/figs/discuss/sdss_qso_pm_significance_rayleigh_fit.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.9\linewidth]{paper/figs/discuss/pm_correlation_histogram.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.9\linewidth]{paper/figs/discuss/pm_significance_difference_histogram.png}
...
\begin{figure}[htbp]
    ...
    \begin{minipage}[t]{0.65\linewidth}
        \vspace{0pt}
        \centering
        \includegraphics[width=\linewidth]{paper/figs/discuss/error_ellipses.pdf}
    \end{minipage}% 
    \hfill 
    \begin{minipage}[t]{0.3\linewidth}
        \centering
        \vspace{0pt}
        \includegraphics[width=\linewidth]{paper/figs/discuss/legend_only.pdf}
        \vspace{1.5em}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\linewidth]{paper/figs/discuss/m_dist_sq_distribution.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\linewidth]{paper/figs/discuss/sdss_p_zpm_histogram.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\linewidth]{paper//figs//discuss/m_dist_sq_qso_fit.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\linewidth]{paper//figs//discuss/RUWE_distribution.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{paper//figs//discuss/SpecById.ashx.png}
